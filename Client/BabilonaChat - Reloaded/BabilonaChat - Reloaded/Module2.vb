...
Module Module2
    Public NotInheritable Class FlashWindow
        ...
        ''' <returns> </returns>
        Public Shared Function Flash(ByVal form As Form) As Boolean
        ...
        ''' <returns> </returns>
        Public Shared Function Flash(ByVal form As Form, ByVal count As UInteger) As Boolean
            If Win2000OrLater Then
        ...
        ''' <param name="form"> The Form (Window) to Flash. </param>
        ''' <returns> </returns>
        Public Shared Function Start(ByVal form As Form) As Boolean
            If Win2000OrLater Then
        ...
        ''' <returns> </returns>
        Public Shared Function [Stop](ByVal form As Form) As Boolean
            If Win2000OrLater Then
